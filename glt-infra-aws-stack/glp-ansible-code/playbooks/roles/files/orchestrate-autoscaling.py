...
parser=argparse.ArgumentParser(description='Arguments for managing GLT-services with ecs')
           ...
           for svc in modules['serviceCreate']:
               ...
               try:
                  ...
                  if createResponse == 200:
                     ...
                     setupServiceScale(mode,svcServiceName,svcCluster)
                     # verbose
                     if mode:
...
def setupServiceScale(mode,serviceName,clusterName,roleArn="arn:aws:iam::953030164212:role/ecs-application-autoscale"):
    """Function to setup scaling policies target"""
    client = boto3.client('application-autoscaling',region_name=region)
    response = client.put_scaling_policy(
      PolicyName=serviceName+'-CPU-trigger',
